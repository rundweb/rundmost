...
const ServiceComponents = () => {
  ...
  return (
    <div className="bg-black-secondary mt-5">
      <div className="px-5 max-w-7xl gap-10 m-auto py-12 flex flex-col items-center w-full">
        ...
        <div className="flex flex-col gap-10 justify-between  w-full">
          {service.map((item) => (
            <div
              key={item.title}
              className="bg-service shadow-lg  w-full p-7 h-60  flex flex-col justify-between"
            >
