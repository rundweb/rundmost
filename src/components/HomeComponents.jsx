  ...
  return (
    <div className="flex flex-col gap-5 p-5 max-w-7xl m-auto items-center justify-center text-center md:max-w-5xl md:gap-10 md:mt-5 lg:mt-7">
      ...
      <div className="flex gap-2 items-center justify-center md:gap-5">
        <a href="" className="w-auto text-white bg-green-primary border-2 border-green-primary px-5 py-2 rounded-xl text-sm font-semibold
        md:text-lg">Get Started</a>
        <a href="" className="w-auto text-green-primary border-2 border-green-primary px-5 py-2 rounded-xl text-sm font-semibold
        md:text-lg">Try Demo</a>
      </div>
    </div>
  )
}
